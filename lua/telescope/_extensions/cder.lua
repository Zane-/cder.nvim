...
if not has_telescope then
	error('cder requires telescope.nvim: https://github.com/nvim-telescope/telescope.nvim')
end
...
local opts = {
	...
	-- the previewer_commadand as input.
	-- Example without bat:
		...
		previewer = previewers.new_termopen_previewer({
			get_command = function(entry)
				return vim.tbl_flatten({
				  ...
				  opts.previewer_command .. ' ' .. entry.value .. ' | ' .. opts.pager_command
				})
			end,
		}),
